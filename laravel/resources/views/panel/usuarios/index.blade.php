@extends('../../layouts.panel', ['title' => 'Listado de usuarios', 'menu_item' => '#menu-3',] ) 
@section('estilos') {{--
...
<script>
	...
	tablas["tabla-usuarios"] = $("#table-usuarios").DataTable({
		...
		"columnDefs":[
			{"targets":10, "data":null, "defaultContent":'<a tabindex class="btn-show btn btn-outline-info m-btn m-btn--outline-2x m-btn--square btn-sm"><i class="la la-search la-2x"></i></a>'}
		],
